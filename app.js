...
function getPersonalityDetails(code) {
  ...
  const detailsMap = {
    ...
    'IMFW': {
      ...
      growthTips: {
        zh: ['建立自信', '学会表达真实想法', '不要过度在意他人评价', '培养抗压能力', '接受自己的敏感'],
        en: ['Build confidence', 'Learn to express true thoughts', "Don't over-care about others' opinions", 'Develop stress resistance', 'Accept your sensitivity']
      }
    },
  };
  
  return detailsMap[code] || null;
}
